...
{
    public class SantaComm
    {
        public string Message { get; set; }

        public List<string> RepetitionCode
        {
            get
            {
